...
namespace Dypsloom.RhythmTimeline.Scoring
{
    ...
    public class ScoreManager : MonoBehaviour
    {
        ...
        protected float m_ScoreMultiplier;
        ...
        private void HandleOnNoteTriggerEvent(NoteTriggerEventData noteTriggerEventData)
        {
            ...
            ScorePopup(spawnTransform.position, noteAccuracy);
        }
        ...
        {
            var maxScore = m_CurrentSong.RhythmClipCount * m_ScoreSettings.MaxNoteScore;
            var percentage = m_CurrentScore * 100 / maxScore;
            return percentage;
        }
        ...
        public virtual void ScorePopup(Vector3 spawnPoint, NoteAccuracy noteAccuracy)
        {
            Pop(noteAccuracy.popPrefab, spawnPoint);
        }

        public virtual void Pop(GameObject prefab, Vector3 spawnPoint)
        {
            PoolManager.Instantiate(prefab, spawnPoint, Quaternion.identity);
        }
    }
}
