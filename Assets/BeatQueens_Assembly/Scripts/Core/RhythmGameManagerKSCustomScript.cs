...
namespace Dypsloom.RhythmTimeline.Core.Managers
{
    ...
    public class RhythmGameManagerKSCustomScript : MonoBehaviour
    {
        ...
        [SerializeField] protected SongChooserPanelKS m_SongChooser;
        ...
        public SongChooserPanelKS SongChooser => m_SongChooser;
       // public SongChooserPanelKS MySongChooser => m_SongChooser;
